...
[{
    ...
    _respawnIn = parseText format ["<t align='center' size='1.4'>Player: <t color='#ffff00'>%1</t></t>", _timeleftStr];
    ...
    _explanation = parseText "<t align ='center' size='1.4'>Waiting for player-countdown.</t>";
