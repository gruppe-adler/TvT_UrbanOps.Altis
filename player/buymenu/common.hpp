...
class w_RscButton
{
   access = 0;
	...
	colorBackground[] = {BUYMENU_COLOR_R * 0.8, BUYMENU_COLOR_G * 0.8, BUYMENU_COLOR_B * 0.8, 1}; // normal
	colorFocused[] = {BUYMENU_COLOR_R * 0.55, BUYMENU_COLOR_G * 0.55, BUYMENU_COLOR_B * 0.55, 1}; // pulse
	colorBackgroundActive[] = {BUYMENU_COLOR_R, BUYMENU_COLOR_G, BUYMENU_COLOR_B, 1}; // hover
...
class w_RscCombo {
	...
	colorSelect[] = {1, 0, 0, 1};
	colorSelectBackground[] = {BUYMENU_COLOR_R, BUYMENU_COLOR_G, BUYMENU_COLOR_B, 0.5};
