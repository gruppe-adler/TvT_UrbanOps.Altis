class grad_aicommand_RscTopBar {
...
class grad_aicommand_RscControlsGroup {
    deletable = 0;
    fade = 0;
    h = 1;
    idc = -1;
...
class grad_aicommand_RscControlsGroupNoScrollbars: grad_aicommand_RscControlsGroup {
    deletable = 0;
    fade = 0;
    h = 1;
    idc = -1;
...
class grad_aicommand_RscMapControl {
	access = 0;
	idc = -1;
	type = CT_MAP_MAIN;
	style = ST_PICTURE;
