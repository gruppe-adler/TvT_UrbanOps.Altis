...
if (hasInterface) then {
    _action = ["grad_aicommand_actionNode", "AI command", "\A3\ui_f\data\igui\cfg\simpleTasks\types\whiteboard_ca.paa", {_this call grad_aicommand_fnc_waitASecond}, {!((group (_this select 0)) getVariable ["grad_aicommand_isBeingEdited",false]) && _this call grad_aicommand_fnc_canGiveCommands}, {},[],"",0,[false, false, false, true, false]] call ace_interact_menu_fnc_createAction;
